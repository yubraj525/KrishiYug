...
<div className="w-full  bg-white flex items-start justify-evenly">
  ...
  <div className="flex  bg-pink-500  border-l-2 items-center p-10 justify-center flex-col  h- autofill: ">
    <ContactForm/>
  </div>
</div>
</div>
