...
const Home = () => {
  ...
  return (
    <>
      <div className="  h-150 space-y-2.5 bg-gray-100 flex flex-col items-center justify-center p-5">
        <h1 className=" font-bold text-3xl">Discover your skills!!</h1>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. ishan khatri
